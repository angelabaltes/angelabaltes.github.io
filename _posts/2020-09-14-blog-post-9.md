...
1. User (who will be the user of this product?). 2. What problem will this product solve (the solution needs to be actionable). 3. There needs to be data available for this product! 
